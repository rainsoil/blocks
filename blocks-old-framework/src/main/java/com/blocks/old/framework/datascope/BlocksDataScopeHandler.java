package com.blocks.old.framework.datascope;

import com.blocks.common.data.datascope.DataScopeHandler;
 ...
 **/
@Component
public class BlocksDataScopeHandler implements DataScopeHandler {
    /**
     * 全部数据权限
     */
    ...
    @Override
    public void handler(JoinPoint point, DataScope controllerDataScope) {
