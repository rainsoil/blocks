...
import com.blocks.old.common.xss.Xss;
...
public class SysUser extends BaseEntity {
    ...
    @ExcelProperty(value = "帐号状态",converter = DictStrFormatConverter.class)
     ...
     */
//    @Excels({
//            @ExcelProperty(value = "部门名称", targetAttr = "deptName", type = Type.EXPORT),
//            @ExcelProperty(value = "部门负责人", targetAttr = "leader", type = Type.EXPORT)
//    })
